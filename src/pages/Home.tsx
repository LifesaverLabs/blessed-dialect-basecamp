      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Evolving language toward increased harmlessness—helping us{" "}
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-card p-8 rounded-lg border border-border shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  language evolution, we aim to help everyone reach the 100 and 120 year milestones.
                </p>
              </div>
              ...
              <div className="bg-card p-8 rounded-lg border border-border shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  of collective, peaceful effort toward shared human goals.
                </p>
              </div>
              ...
              <div className="bg-card p-8 rounded-lg border border-border shadow-sm">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  This is experimental language evolution—unstable, rapid, consensus-driven. Changes happen when needs
                  appear. Not all language is well-tested; it just needs to show promise.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
            <p>
              ...
              American language, designed to evolve rapidly as human needs emerge. We're building a linguistic framework
            ...
            <p>
              ...
              our forum—we shape language that helps us reach deep human wellbeing. Our goal: help everyone reach 100
            ...
            <p className="text-sm italic border-l-4 border-primary pl-4 py-2">
              ...
              an extension of English for Humans and American for Humans—language that serves people first.
            </p>
          </div>
        </div>
      </section>
